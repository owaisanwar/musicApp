...
function createPlayer(songLink) {
    ...
    playerDiv.innerHTML = `
    <iframe width="560" height="315" src="https://www.youtube.com/embed/CKZvWhCqx1s?si=OmDfmJXj-Lz1vUMt?autoplay=1&mute=1" title="YouTube video player" frameborder="0"  allow="autoplay" allowfullscreen></iframe>
    `
    // playerDiv.innerHTML = `
